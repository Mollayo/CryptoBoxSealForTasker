...
public class TaskerPlugin {
    ...
    /**
     * Action that the EventEditActivity for an event plugin should be launched by
     */
     ...
     * <p/>
     * Used in EventEditActivity, before setResult().
     *
    ...
    /**
     * Used by: plugin EventQueryReceiver, FireReceiver
     * <p/>
    ...
    public static class Setting {
        ...
        /**
         * Used by: plugin EventEditActivity.
         * <p/>
    ...
    public static class Condition {
        ...
        /**
         * Used by: plugin EventQueryReceiver
         * <p/>
         * Indicates to plugin whether the host will process variables which it passes back
         *
         * @param extrasFromHost intent extras from the intent received by the EventQueryReceiver
         * @see #addVariableBundle(Bundle, Bundle)
         */
        public static boolean hostSupportsVariableReturn(Bundle extrasFromHost) {
    ...
    public static class Host {
         ...
         * intents to any EventEditActivity, FireReceiver or EventQueryReceiver.
         *
